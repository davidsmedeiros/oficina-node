...
module.exports = {
  async up (queryInterface, Sequelize) {
    return queryInterface.sequelize.query(`
      ...
      ALTER SEQUENCE public."Mains_id_seq" OWNED BY "${tableName}".id;
      ALTER TABLE "${tableName}" ALTER COLUMN ${newColumn} SET DEFAULT nextval('public."Mains_id_seq"');
